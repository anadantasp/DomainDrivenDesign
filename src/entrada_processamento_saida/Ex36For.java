...
/*
 * Exercício 36 - Entrar via teclado com um valor (X) qualquer. Travar a digitação, no sentido de aceitar somente 
...
public class Ex36For {
	...
	public static void main(String[] args) {
		...
		for(int i = intervaloFinal; i >= intervaloInicial; i--) {
			res = num * i;
